...
const luminosidade1 = ArduinoDataLuminosity.List[ArduinoDataLuminosity.List.length -1]
const luminosidade2 = (ArduinoDataLuminosity.List[ArduinoDataLuminosity.List.length -1] + 100)
const luminosidade3 = (ArduinoDataLuminosity.List[ArduinoDataLuminosity.List.length -1] - 300)
const luminosidade4 = (ArduinoDataLuminosity.List[ArduinoDataLuminosity.List.length -1] + 272)

db.conectar()
    .then(() => {
        const sql = `
        INSERT into dados (lumens, momento, fkSensor)
        values (${luminosidade1},'${agora()}',1),(${luminosidade2},'${agora()}',2),(${luminosidade3},'${agora()}',5),(${luminosidade4},'${agora()}',6);`;
        console.log(sql);
